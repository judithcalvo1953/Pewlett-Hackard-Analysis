...
--drop the queried table so we can add in emp_no then comment out to avoid accidently killing it later
...
--new retiree and dept table with info for 7.3.6 skill drill
SELECT ce.emp_no,
ce.first_name,
ce.last_name,
d.dept_name
